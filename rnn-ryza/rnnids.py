...
def init_model(type, hidden_layers, seq_length, dropout):
    ...
    rnn_model.summary()
    plot_model(rnn_model, to_file='model_plot_lstm_old.png', show_shapes=True, show_layer_names=True)
...
def check_directory(filename, root = "/Users/angelaoryza/Documents/TA/noisy-rnnids/rnnids-py/models"):
